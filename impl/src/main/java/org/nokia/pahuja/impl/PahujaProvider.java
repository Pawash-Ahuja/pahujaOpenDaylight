...
import org.nokia.pahuja.topologyManager.NeighborTopology;
...
public class PahujaProvider implements BindingAwareProvider, AutoCloseable, PacketProcessingListener, OpendaylightInventoryListener, SalFlowListener, FlowTopologyDiscoveryListener {
...
//      DataBroker db = session.getSALService(DataBroker.class);
    ...
    public  void onPacketReceived(PacketReceived notification) {
       ...
       // System.out.println("packet received");
        ...
        if (etherType == 0x88cc){
        	...
        	System.out.println("LLDP Packet received");
        	System.out.println(notification.getPayload().toString());
        	System.out.println();
        	System.out.println(notification.getPacketInReason());
        	System.out.println();
        	//LLDP ldp = notification.getPayload();
	...
	public void onNodeRemoved(NodeRemoved notification) {
		...
		new NeighborTopology().removeNode(notification.getNodeRef().toString().substring(324, 334));
